<x-app-layout>
    <x-slot name="header">
        <h2 class="h4">إضافة مديونية جديدة</h2>
    </x-slot>
        ...
        <form action="{{ route('debts.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select name="status" id="status" class="form-select" required>
                    <option value="debit" {{ old('status')=='debit' ? 'selected':'' }}>مدين</option>
                    <option value="credit" {{ old('status')=='credit' ? 'selected':'' }}>دائن</option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="installments_count" id="installments_count" class="form-control" min="1">
            </div>

            <div class="mb-3" id="installment-dates-container"></div>
